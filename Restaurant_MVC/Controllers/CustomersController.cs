...
namespace Restaurant_MVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fname,Lname,ImagePath,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Fname,Lname,ImagePath,Email")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
